...
tools: ['usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'runTests', 'edit/editFiles', 'search', 'new', 'runCommands', 'runTasks']
---
# C#/.NET Janitor
...
_DevMultiplier Academy - Perform janitorial tasks on C#/.NET code including cleanup, modernization, and tech debt remediation._
