    ...
    <section className="bg-[#f6f8fa] py-24 sm:py-32 dark:bg-[#0d1117]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-sm font-semibold tracking-wider text-[#0969da] uppercase dark:text-[#4493f8]">
            Curriculum
          </h2>
          <p className="mt-2 text-3xl font-semibold tracking-tight text-[#1f2328] sm:text-4xl dark:text-[#e6edf3]">
        ...
        <div className="mx-auto mt-16 grid max-w-5xl gap-6 md:grid-cols-2 lg:grid-cols-3">
          {courses.map((course) => (
            <Link
              ...
              className="group relative flex flex-col rounded-md border border-[#d1d9e0] bg-white p-6 transition-all hover:border-[#0969da] hover:shadow-md dark:border-[#30363d] dark:bg-[#161b22] dark:hover:border-[#4493f8]"
            >
              {/* Icon */}
              ...
              {/* Title */}
              <h3 className="text-lg font-semibold text-[#1f2328] transition-colors group-hover:text-[#0969da] dark:text-[#e6edf3] dark:group-hover:text-[#4493f8]">
                {course.title}
              </h3>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {course.topics.map((topic) => (
                  <span
                    key={topic}
                    className="inline-block rounded-full border border-[#54aeff66] bg-[#ddf4ff] px-2.5 py-0.5 text-xs font-medium text-[#0969da] dark:border-[#4493f866] dark:bg-[#388bfd26] dark:text-[#4493f8]"
                  >
                    {topic}
                  </span>
                ))}
