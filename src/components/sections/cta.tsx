    ...
    <section className="border-t border-[#d1d9e0] bg-[#f6f8fa] py-24 sm:py-32 dark:border-[#30363d] dark:bg-[#0d1117]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-[#1f2328] sm:text-4xl dark:text-[#e6edf3]">
          ...
          {status === 'success' ? (
            <div className="mt-8 rounded-md border border-[#1f883d]/30 bg-[#1f883d]/10 p-4 text-[#1a7f37] dark:border-[#238636]/40 dark:bg-[#238636]/20 dark:text-[#3fb950]">
            ...
            >
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-md bg-[#1f883d] px-6 py-3 font-medium text-white transition-colors hover:bg-[#1a7f37] disabled:opacity-50 dark:bg-[#238636] dark:hover:bg-[#2ea043]"
                >
                  {status === 'loading' ? (
                    'Subscribing...'
                  ) : (
