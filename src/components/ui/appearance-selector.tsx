...
export function AppearanceSelector() {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-full right-0 z-50 mt-2 min-w-[140px] rounded-md border border-[#d1d9e0] dark:border-[#30363d] bg-white dark:bg-[#161b22] py-1 shadow-lg">
