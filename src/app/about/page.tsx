        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12">
            ...
            <p className="text-slate mt-4 text-lg leading-8">
              We believe the best developers {"aren't"} just faster coders—{"they're"} better architects, better
              communicators, and better at leveraging the right tools. DevMultiplier Academy exists to help experienced
              developers multiply their impact by mastering modern architecture patterns and AI-assisted development
              practices.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <p className="text-slate mt-4 text-lg leading-8">
              ...
              knowledge. Specifically, knowledge of how to design systems that scale, how to optimize for performance,
              and how to leverage AI tools effectively.
            </p>
            <p className="text-slate mt-4 text-lg leading-8">
