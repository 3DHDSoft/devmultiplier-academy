...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for DevMultiplier Academy - Learn how we collect, use, and protect your personal information.',
};
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              Welcome to DevMultiplier Academy, a division of 3D HD Soft, LLC (&quot;we,&quot; &quot;our,&quot; or
              &quot;us&quot;). We are committed to protecting your privacy and ensuring the security of your personal
            ...
            <div className="border-blue bg-blue/5 my-6 rounded-lg border-l-4 p-4">
              <strong>Our Mission:</strong> Empowering developers to become 10x-100x more productive in the age of AI
              through comprehensive courses covering Domain-Driven Design, CQRS, database optimization, REST API
              development, and AI-assisted UI design.
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              When you access our website and platform, we automatically collect certain information, including:
            </p>
            <ul className="mt-2 list-disc pl-6">
            ...
            <p className="mt-2">
              To enhance your learning experience and provide personalized recommendations, we collect:
            </p>
            <ul className="mt-2 list-disc pl-6">
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              Our courses and platform integrate with various AI technologies and third-party services to enhance your
              learning experience:
            </p>
            ...
            <p className="mt-2">
              When you interact with these AI features, your code submissions and queries may be processed by these
              third-party AI services in accordance with their respective privacy policies.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              ...
              processing payments, hosting content, and providing customer support. These providers are contractually
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              ...
              These countries may have different data protection laws. When we transfer your data internationally, we
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              After you close your account or upon your request, we will delete or anonymize your information within a
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              Our website and courses may contain links to third-party websites, plugins, and applications. We are not
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              Our legal basis for processing includes consent, contract performance, legal obligations, and legitimate
              interests.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              Your continued use of our services after the effective date constitutes acceptance of the updated Privacy
              Policy.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="mt-6 rounded-lg bg-gray-100 p-6">
              ...
              <p className="mb-2">
                <strong>Email:</strong>{' '}
                <Link
                  href="mailto:privacy@devmultiplier.com"
                  className="text-blue hover:underline"
                >
