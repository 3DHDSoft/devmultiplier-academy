...
export const metadata: Metadata = {
  ...
  description:
    'Terms of Service for DevMultiplier Academy - Read our terms and conditions for using our educational platform and services.',
};
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              Welcome to DevMultiplier Academy, a division of 3D HD Soft, LLC (&quot;Company,&quot; &quot;we,&quot;
              &quot;us,&quot; or &quot;our&quot;). These Terms of Service (&quot;Terms&quot;) govern your access to and
              use of our website{' '}
              <Link
                href="https://www.DevMultiplier.com"
                className="text-blue hover:underline"
              >
                www.DevMultiplier.com
              </Link>{' '}
              (&quot;Website&quot;) and all related services, courses, content, and products (collectively, the
              &quot;Services&quot;).
            </p>
            <p className="mt-4">
            ...
            <div className="border-blue bg-blue/5 my-6 rounded-lg border-l-4 p-4">
              <strong>Important:</strong> Please read these Terms carefully before using our Services. These Terms
              contain important information about your legal rights, remedies, and obligations.
            </div>
          </section>

          {/* Section 2 */}
          <section className="mb-10">
            <h2 className="text-navy border-b-2 border-gray-200 pb-2 text-2xl font-semibold">
              2. Description of Services
            </h2>
            <p className="mt-4">
              DevMultiplier Academy provides online educational courses and resources focused on software development,
            ...
            <p className="mt-4">
              Our Services are designed for professional developers, CTOs, and senior technical professionals seeking to
              enhance their skills in modern software development practices.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              You must be at least 18 years old to create an account. By creating an account, you represent that you are
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              When you purchase a course or subscription, you receive a limited, non-exclusive, non-transferable license
              to access and view the course content for your personal, non-commercial use.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">4.2 Lifetime Access</h3>
            <p className="mt-2">
              Individual course purchases include lifetime access to the purchased content, subject to the continued
              operation of our platform. &quot;Lifetime&quot; refers to the lifetime of the course on our platform.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">4.3 Subscription Plans</h3>
            <p className="mt-2">
              Subscription plans provide access to specified content for the duration of your subscription. Access
              terminates when your subscription ends unless you renew.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">4.4 Team Licenses</h3>
            <p className="mt-2">
              Team licenses are for the specified number of seats only. Each team member must have their own account.
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              All prices are displayed in US dollars unless otherwise specified. We reserve the right to change prices
              at any time without notice, though price changes will not affect existing purchases.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">5.2 Payment Processing</h3>
            <p className="mt-2">
              Payments are processed through secure third-party payment processors. By making a purchase, you agree to
              their terms of service.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">5.3 Taxes</h3>
            <p className="mt-2">
              Prices may not include applicable taxes. You are responsible for paying all taxes associated with your
              purchases.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">5.4 Subscription Billing</h3>
            <p className="mt-2">
              Subscriptions are billed automatically at the beginning of each billing period. You authorize us to charge
              your payment method for recurring fees until you cancel.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              We offer a 30-day money-back guarantee for individual course purchases. If you are not satisfied with a
              course, you may request a full refund within 30 days of purchase.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">6.2 Bundles</h3>
            <p className="mt-2">
              Course bundles are eligible for a full refund within 30 days of purchase, provided you have not completed
              more than 25% of the total bundle content.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">6.3 Subscriptions</h3>
            <p className="mt-2">
              Subscription payments are non-refundable. You may cancel your subscription at any time, and access will
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              All course content, materials, text, graphics, videos, code examples, and other materials on our Services
              are owned by or licensed to DevMultiplier Academy and are protected by copyright, trademark, and other
              intellectual property laws.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">7.2 License Grant</h3>
            <p className="mt-2">
              Upon purchase, we grant you a limited, non-exclusive, non-transferable license to access and use the
              course content for personal educational purposes only.
            </p>
            ...
            <p className="mt-2">
              Code examples provided in courses may be used in your personal and commercial projects, subject to any
              specific license terms indicated in the course materials.
            </p>
          </section>
          ...
          <section className="mb-10">
            <h2 className="text-navy border-b-2 border-gray-200 pb-2 text-2xl font-semibold">
              9. Third-Party Services and AI Tools
            </h2>

            <h3 className="text-navy mt-6 text-xl font-medium">9.1 Third-Party Integrations</h3>
            <p className="mt-2">
              Our courses may reference or integrate with third-party tools and services, including:
            </p>
            <ul className="mt-2 list-disc pl-6">
            ...
            <p className="mt-2">
              Your use of third-party services is governed by their respective terms of service and privacy policies. We
              are not responsible for third-party services.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">9.3 AI-Generated Content</h3>
            <p className="mt-2">
              Some course materials may include examples of AI-generated content. You are responsible for verifying and
              validating any AI-generated code or content before use in production systems.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, DEVMULTIPLIER ACADEMY AND 3D HD SOFT, LLC SHALL NOT BE LIABLE FOR:
            </p>
            <ul className="mt-2 list-disc pl-6">
            ...
            <p className="mt-4">
              Some jurisdictions do not allow the exclusion of certain warranties or limitation of liability, so some of
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">
              You agree to indemnify, defend, and hold harmless DevMultiplier Academy, 3D HD Soft, LLC, and their
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              Any dispute arising from these Terms shall first be attempted to be resolved through informal negotiation.
              If unsuccessful, disputes shall be resolved through binding arbitration in accordance with the rules of
              the American Arbitration Association.
            </p>

            <h3 className="text-navy mt-6 text-xl font-medium">13.3 Class Action Waiver</h3>
            <p className="mt-2">
              You agree to resolve any disputes on an individual basis and waive any right to participate in a class
          ...
          <section className="mb-10">
            ...
            <p className="mt-2">
              ...
              DevMultiplier Academy regarding our Services.
            </p>
          ...
          <section className="mb-10">
            ...
            <div className="mt-6 rounded-lg bg-gray-100 p-6">
              ...
              <p className="mb-2">
                <strong>Email:</strong>{' '}
                <Link
                  href="mailto:legal@devmultiplier.com"
                  className="text-blue hover:underline"
                >
