  ...
  return (
    <div className="min-h-screen bg-[#f6f8fa] dark:bg-[#0d1117]">
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        {/* Welcome Section */}
        <div className="mb-12">
          <h2 className="mb-4 text-3xl font-bold text-[#1f2328] dark:text-[#e6edf3]">
            Welcome, {session.user?.name || 'Student'}!
          </h2>
          <p className="text-[#656d76] dark:text-[#848d97]">
            Start learning with our courses or continue where you left off.
          </p>
        </div>
        ...
        <div className="mb-8 rounded-lg border border-[#d1d9e0] bg-white p-6 shadow dark:border-[#30363d] dark:bg-[#161b22]">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-[#1f2328] dark:text-[#e6edf3]">
                {(session.user as { locale?: string })?.locale || 'English'}
              </p>
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <Link
            href="/courses"
            className="cursor-pointer rounded-lg border border-[#d1d9e0] bg-white p-6 shadow transition hover:border-[#0969da] hover:shadow-lg dark:border-[#30363d] dark:bg-[#161b22] dark:hover:border-[#4493f8]"
          >
