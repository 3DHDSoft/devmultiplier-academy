        ...
        <div className="rounded-lg border border-[#d1d9e0] bg-white p-5 shadow-xl dark:border-[#30363d] dark:bg-[#161b22]">
          ...
          {emailNotVerified && (
            <div className="mb-3 rounded-md border border-[#d4a72c66] bg-[#fff8c5] p-3 dark:border-[#d29922] dark:bg-[#674d1a]">
              <div className="flex items-start gap-2">
                <svg className="h-5 w-5 flex-shrink-0 text-[#9a6700] dark:text-[#d29922]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-[#6e5600] dark:text-[#c69026]">Please check your email and click the verification link before signing in.</p>
                  {resendSuccess ? (
                    <p className="mt-2 text-sm text-[#1a7f37] dark:text-[#3fb950]">✓ Verification email sent! Check your inbox.</p>
                  ) : (
                    <button type="button" onClick={handleResendVerification} disabled={isResendingEmail} className="mt-2 text-sm font-medium text-[#0969da] hover:underline disabled:opacity-50 dark:text-[#4493f8]">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-[#0969da] hover:underline dark:text-[#4493f8]">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="space-y-1.5">
            {/* GitHub */}
            <button type="button" onClick={() => handleOAuthSignIn('github')} disabled={isLoading} className="flex w-full items-center justify-center gap-2 rounded-md border border-[#d1d9e0] bg-white px-3 py-1.5 text-sm font-medium text-[#1f2328] transition hover:bg-[#f6f8fa] disabled:cursor-not-allowed disabled:opacity-50 dark:border-[#30363d] dark:bg-[#21262d] dark:text-[#e6edf3] dark:hover:bg-[#30363d]">
            ...
            {/* Google */}
            <button type="button" onClick={() => handleOAuthSignIn('google')} disabled={isLoading} className="flex w-full items-center justify-center gap-2 rounded-md border border-[#d1d9e0] bg-white px-3 py-1.5 text-sm font-medium text-[#1f2328] transition hover:bg-[#f6f8fa] disabled:cursor-not-allowed disabled:opacity-50 dark:border-[#30363d] dark:bg-[#21262d] dark:text-[#e6edf3] dark:hover:bg-[#30363d]">
            ...
            {/* Microsoft */}
            <button type="button" onClick={() => handleOAuthSignIn('microsoft-entra-id')} disabled={isLoading} className="flex w-full items-center justify-center gap-2 rounded-md border border-[#d1d9e0] bg-white px-3 py-1.5 text-sm font-medium text-[#1f2328] transition hover:bg-[#f6f8fa] disabled:cursor-not-allowed disabled:opacity-50 dark:border-[#30363d] dark:bg-[#21262d] dark:text-[#e6edf3] dark:hover:bg-[#30363d]">
              <svg className="h-4 w-4" viewBox="0 0 24 24">
            ...
            {/* LinkedIn */}
            <button type="button" onClick={() => handleOAuthSignIn('linkedin')} disabled={isLoading} className="flex w-full items-center justify-center gap-2 rounded-md border border-[#d1d9e0] bg-white px-3 py-1.5 text-sm font-medium text-[#1f2328] transition hover:bg-[#f6f8fa] disabled:cursor-not-allowed disabled:opacity-50 dark:border-[#30363d] dark:bg-[#21262d] dark:text-[#e6edf3] dark:hover:bg-[#30363d]">
          ...
          <p className="mt-3 text-center text-sm text-[#656d76] dark:text-[#848d97]">
            ...
            <Link href="/register" className="font-medium text-[#0969da] hover:underline dark:text-[#4493f8]">
              Sign up
            </Link>
          </p>
