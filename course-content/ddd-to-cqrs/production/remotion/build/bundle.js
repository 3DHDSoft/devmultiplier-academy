...
const loadFonts = async () => {
  ...
  const handle = (0,esm.delayRender)("Loading fonts...");
  try {
...
const fontFamily = "'Inter', 'Apple Color Emoji', 'Segoe UI Emoji', 'Noto Color Emoji', system-ui, -apple-system, sans-serif";
...
const StickyNote = ({ text, color, delay = 0, x, y, width = 180, fontSize = 20 }) => {
  ...
  const opacity = (0,esm.interpolate)(frame - delay, [0, 10], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const rotation = (0,esm.interpolate)(frame - delay, [0, 15], [-5, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  if (frame < delay) {
  ...
  const containerStyle = { position: "absolute", left: x, top: y, width, opacity, transform: `scale(${scale}) rotate(${rotation}deg)`, transformOrigin: "top left" };
  const noteStyle = {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: containerStyle, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: noteStyle, children: text }) });
};

;// ./src/components/BoundedContext.tsx





const BoundedContext_colorMap = {
  green: {
    bg: "#e8f5e9",
    border: "#2e7d32",
    text: "#1b5e20"
...
const BoundedContext = ({ name, color, x, y, width, height, delay = 0, children }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  (0,react.useEffect)(() => {
    loadFonts();
  }, []);
  const colors = BoundedContext_colorMap[color];
  const borderProgress = (0,esm.spring)({
    frame: frame - delay,
    fps,
    config: {
      damping: 20,
  ...
  const scale = (0,esm.interpolate)(frame - delay, [0, 20], [0.95, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  if (frame < delay) {
  ...
  const containerStyle = { position: "absolute", left: x, top: y, width, height, opacity, transform: `scale(${scale})`, transformOrigin: "center center" };
  const backgroundStyle = { position: "absolute", inset: 0, backgroundColor: colors.bg, borderRadius: "10px", opacity: borderProgress };
  const svgStyle = { position: "absolute", top: 0, left: 0 };
  const labelStyle = { position: "absolute", top: 18, left: 24, fontFamily: fontFamily, fontSize: 28, fontWeight: 700, color: colors.text, textTransform: "uppercase", letterSpacing: "0.02em", opacity: borderProgress };
  const childrenStyle = { position: "relative", paddingTop: 50 };
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: backgroundStyle }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width, height, style: svgStyle, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: 2, y: 2, width: width - 4, height: height - 4, rx: 10, ry: 10, fill: "none", stroke: colors.border, strokeWidth: 4, strokeDasharray, strokeDashoffset }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: labelStyle, children: name }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: childrenStyle, children })
  ] });
};
...
const Arrow = ({ fromX, fromY, toX, toY, delay = 0, color = "#475569", label, dashed = false }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const dx = toX - fromX;
  const dy = toY - fromY;
  ...
  const containerStyle = { position: "absolute", left: 0, top: 0, width: "100%", height: "100%", pointerEvents: "none", opacity };
  const svgStyle = { position: "absolute", left: 0, top: 0, width: "100%", height: "100%", overflow: "visible" };
  const arrowheadStyle = { opacity: (0,esm.interpolate)(progress, [0.8, 1], [0, 1]) };
  const labelStyle = { position: "absolute", left: labelX, top: labelY, transform: "translateX(-50%)", fontFamily: "system-ui, -apple-system, sans-serif", fontSize: 27, fontWeight: 600, color, backgroundColor: "rgba(255,255,255,0.9)", padding: "6px 12px", borderRadius: "6px", opacity: (0,esm.interpolate)(progress, [0.5, 0.8], [0, 1]), whiteSpace: "nowrap" };
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: svgStyle, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: fromX, y1: fromY, x2: currentEndX, y2: currentEndY, stroke: color, strokeWidth: 3, strokeDasharray: dashed ? "10,5" : "none" }),
      progress > 0.8 && /* @__PURE__ */ (0,jsx_runtime.jsx)("polygon", { points: `${currentEndX},${currentEndY} ${arrowPoint1X},${arrowPoint1Y} ${arrowPoint2X},${arrowPoint2Y}`, fill: color, style: arrowheadStyle })
    ] }),
    label && progress > 0.5 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: labelStyle, children: label })
  ] });
};

;// ./src/compositions/EventStormDemo.tsx
...
const EventStormDemo = () => {
  ...
  const titleStyle = { position: "absolute", top: 20, left: 30, fontFamily: fontFamily, fontSize: 36, fontWeight: 700, color: "#0f172a" };
  const legendContainerStyle = { position: "absolute", top: 25, right: 30, display: "flex", gap: 30, fontFamily: fontFamily, fontSize: 28 };
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: titleStyle, children: "E-Commerce Checkout: Event Storm" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendContainerStyle, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: eventSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Event" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: commandSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Command" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: aggregateSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Aggregate" })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Sales Context", color: "green", x: SALES_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 30, durationInFrames: 420, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: SALES_X + 30, top: ROW1_Y, fontSize: 40, width: 40, textAlign: "center" }, children: "\u{1F464}" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: SALES_X + 30, top: ROW1_Y + 48, width: 40, textAlign: "center", fontFamily: fontFamily, fontSize: 21, color: "#1b5e20" }, children: "User" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 45, durationInFrames: 405, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "AddItemToCart", color: "blue", x: SALES_X + 100, y: ROW1_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 75, durationInFrames: 375, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "PlaceOrder", color: "blue", x: SALES_X + 100, y: ROW2_Y, delay: 0, width: 170, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 60, durationInFrames: 390, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ItemAddedToCart", color: "orange", x: SALES_X + 320, y: ROW1_Y, delay: 0, width: 220, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 90, durationInFrames: 360, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderPlaced", color: "orange", x: SALES_X + 320, y: ROW2_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 105, durationInFrames: 345, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order", color: "yellow", x: SALES_X + 340, y: ROW3_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 120, durationInFrames: 330, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Payment Context", color: "orange", x: PAYMENT_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 150, durationInFrames: 300, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ProcessPayment", color: "blue", x: PAYMENT_X + 40, y: ROW1_Y, delay: 0, width: 210, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, durationInFrames: 270, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "PaymentProcessed", color: "orange", x: PAYMENT_X + 280, y: ROW1_Y, delay: 0, width: 240, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 195, durationInFrames: 255, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "PaymentFailed", color: "pink", x: PAYMENT_X + 280, y: ROW2_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 210, durationInFrames: 240, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: PAYMENT_X + 70, top: ROW2_Y + 70, fontFamily: fontFamily, fontSize: 28 }, children: "\u26A1" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: PAYMENT_X + 45, top: ROW2_Y + 105, fontFamily: fontFamily, fontSize: 28, color: "#bf360c" }, children: "Stripe" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 225, durationInFrames: 225, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Payment", color: "yellow", x: PAYMENT_X + 340, y: ROW3_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 240, durationInFrames: 210, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Fulfillment Context", color: "blue", x: FULFILLMENT_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 270, durationInFrames: 180, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "AllocateInventory", color: "blue", x: FULFILLMENT_X + 100, y: ROW1_Y, delay: 0, width: 230, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 300, durationInFrames: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ShipOrder", color: "blue", x: FULFILLMENT_X + 360, y: ROW1_Y, delay: 0, width: 160, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 285, durationInFrames: 165, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "InventoryAllocated", color: "orange", x: FULFILLMENT_X + 40, y: ROW2_Y, delay: 0, width: 240, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 315, durationInFrames: 135, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderShipped", color: "orange", x: FULFILLMENT_X + 300, y: ROW2_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 330, durationInFrames: 120, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Shipment", color: "yellow", x: FULFILLMENT_X + 100, y: ROW3_Y, delay: 0, width: 130, fontSize: CARD_FONT }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Inventory", color: "yellow", x: FULFILLMENT_X + 280, y: ROW3_Y, delay: 0, width: 130, fontSize: CARD_FONT })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 360, durationInFrames: 90, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: SALES_X + 320 + 180, fromY: ROW2_Y + 35, toX: PAYMENT_X + 40, toY: ROW1_Y + 35, delay: 0, color: "#2e7d32", label: "triggers" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 390, durationInFrames: 60, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: PAYMENT_X + 280 + 240, fromY: ROW1_Y + 35, toX: FULFILLMENT_X + 100, toY: ROW1_Y + 35, delay: 0, color: "#e65100", label: "triggers" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 405, durationInFrames: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: PAYMENT_X + 280, fromY: ROW2_Y + 35, toX: SALES_X + 320 + 180, toY: ROW2_Y + 35, delay: 0, color: "#c62828", dashed: true, label: "rollback" }) })
  ] });
};

;// ./src/compositions/ContextMapDemo.tsx
...
const ContextMapDemo = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 360, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: titleStyle, children: "Context Map: E-Commerce Domain" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 360, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendContainerStyle, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: upstreamSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Upstream" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: downstreamSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Downstream" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: partnerSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Partnership" })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 360, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Sales Context", color: "green", x: SALES_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 30, durationInFrames: 330, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Customer", color: "yellow", x: SALES_X + 50, y: ROW1_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 45, durationInFrames: 315, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order", color: "yellow", x: SALES_X + 200, y: ROW1_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 60, durationInFrames: 300, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Product", color: "yellow", x: SALES_X + 350, y: ROW1_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 75, durationInFrames: 285, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderPlaced", color: "orange", x: SALES_X + 120, y: ROW2_Y, delay: 0, width: CARD_WIDTH, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 90, durationInFrames: 270, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderConfirmed", color: "orange", x: SALES_X + 310, y: ROW2_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 105, durationInFrames: 255, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(RoleLabel, { x: SALES_X + CONTEXT_WIDTH / 2, y: CONTEXT_Y + CONTEXT_HEIGHT - 30, text: "UPSTREAM", color: "#22c55e", delay: 0, frame, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 120, durationInFrames: 240, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Inventory Context", color: "orange", x: INVENTORY_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 150, durationInFrames: 210, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "StockItem", color: "yellow", x: INVENTORY_X + 50, y: ROW1_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 165, durationInFrames: 195, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Warehouse", color: "yellow", x: INVENTORY_X + 210, y: ROW1_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, durationInFrames: 180, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Reservation", color: "yellow", x: INVENTORY_X + 370, y: ROW1_Y, delay: 0, width: 140, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 195, durationInFrames: 165, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "StockReserved", color: "orange", x: INVENTORY_X + 120, y: ROW2_Y, delay: 0, width: CARD_WIDTH + 10, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 210, durationInFrames: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "StockDepleted", color: "pink", x: INVENTORY_X + 320, y: ROW2_Y, delay: 0, width: CARD_WIDTH + 10, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 225, durationInFrames: 135, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(RoleLabel, { x: INVENTORY_X + CONTEXT_WIDTH / 2, y: CONTEXT_Y + CONTEXT_HEIGHT - 30, text: "DOWNSTREAM", color: "#f59e0b", delay: 0, frame, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 240, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Shipping Context", color: "blue", x: SHIPPING_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 260, durationInFrames: 100, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Shipment", color: "yellow", x: SHIPPING_X + 50, y: ROW1_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 275, durationInFrames: 85, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Carrier", color: "yellow", x: SHIPPING_X + 210, y: ROW1_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 290, durationInFrames: 70, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "DeliveryRoute", color: "yellow", x: SHIPPING_X + 350, y: ROW1_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 300, durationInFrames: 60, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ShipmentDispatched", color: "orange", x: SHIPPING_X + 60, y: ROW2_Y, delay: 0, width: 240, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 315, durationInFrames: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ShipmentDelivered", color: "orange", x: SHIPPING_X + 320, y: ROW2_Y, delay: 0, width: 220, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 330, durationInFrames: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(RoleLabel, { x: SHIPPING_X + CONTEXT_WIDTH / 2, y: CONTEXT_Y + CONTEXT_HEIGHT - 30, text: "PARTNER", color: "#3b82f6", delay: 0, frame, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 135, durationInFrames: 225, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: SALES_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: INVENTORY_X, toY: CONTEXT_Y + 200, delay: 0, color: "#22c55e", label: "Customer/Supplier" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 255, durationInFrames: 105, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: INVENTORY_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: SHIPPING_X, toY: CONTEXT_Y + 200, delay: 0, color: "#3b82f6", label: "Partnership" }) })
  ] });
};
const RoleLabel = ({ x, y, text, color, delay, frame, fps }) => {
  const opacity = (0,esm.interpolate)(frame - delay, [0, 15], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const scale = (0,esm.spring)({ frame: frame - delay, fps, config: { damping: 15, stiffness: 100 } });
  if (frame < delay) return null;
  const labelStyle = { position: "absolute", left: x, top: y, transform: `translateX(-50%) scale(${scale})`, fontFamily: fontFamily, fontSize: 18, fontWeight: 700, color, backgroundColor: "rgba(255,255,255,0.9)", padding: "6px 14px", borderRadius: 6, border: `2px solid ${color}`, opacity, letterSpacing: 1 };
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: labelStyle, children: text });
};

;// ./src/compositions/CQRSArchitecture.tsx
...
const CQRSArchitecture = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: titleStyle, children: "CQRS: Command Query Responsibility Segregation" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendContainerStyle, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: commandSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Command" })
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: querySwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Query" })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Command Side (Write)", color: "orange", x: COMMAND_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 30, durationInFrames: 420, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: COMMAND_X + 30, top: ROW1_Y, fontSize: 40, width: 40, textAlign: "center" }, children: "\u{1F464}" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: COMMAND_X + 30, top: ROW1_Y + 48, width: 40, textAlign: "center", fontFamily: fontFamily, fontSize: 21, color: "#9a3412" }, children: "User" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 45, durationInFrames: 405, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "PlaceOrder", color: "blue", x: COMMAND_X + 90, y: ROW1_Y, delay: 0, width: 140, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 60, durationInFrames: 390, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "UpdateOrder", color: "blue", x: COMMAND_X + 250, y: ROW1_Y, delay: 0, width: 150, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 75, durationInFrames: 375, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "CancelOrder", color: "blue", x: COMMAND_X + 410, y: ROW1_Y, delay: 0, width: 150, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 90, durationInFrames: 360, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "CommandHandler", color: "orange", x: COMMAND_X + 100, y: ROW2_Y, delay: 0, width: 220, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 105, durationInFrames: 345, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Validator", color: "orange", x: COMMAND_X + 350, y: ROW2_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 120, durationInFrames: 330, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order", color: "yellow", x: COMMAND_X + 180, y: ROW3_Y, delay: 0, width: 110, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 135, durationInFrames: 315, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "WriteDB", color: "pink", x: COMMAND_X + 320, y: ROW3_Y, delay: 0, width: 110, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 150, durationInFrames: 300, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Event Store", color: "purple", x: EVENT_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, durationInFrames: 270, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderPlaced", color: "orange", x: EVENT_X + 40, y: ROW1_Y, delay: 0, width: 150, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 195, durationInFrames: 255, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderUpdated", color: "orange", x: EVENT_X + 210, y: ROW1_Y, delay: 0, width: 160, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 210, durationInFrames: 240, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderCancelled", color: "orange", x: EVENT_X + 380, y: ROW1_Y, delay: 0, width: 190, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 225, durationInFrames: 225, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "EventBus", color: "pink", x: EVENT_X + 180, y: ROW2_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 240, durationInFrames: 210, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Projector", color: "pink", x: EVENT_X + 340, y: ROW2_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 255, durationInFrames: 195, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: EVENT_X + 240, top: ROW3_Y, fontSize: 32 }, children: "\u{1F4BE}" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: EVENT_X + 180, top: ROW3_Y + 40, fontFamily: fontFamily, fontSize: 21, color: "#7e22ce" }, children: "Append-Only Log" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 270, durationInFrames: 180, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Query Side (Read)", color: "green", x: QUERY_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 300, durationInFrames: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "GetOrder", color: "blue", x: QUERY_X + 50, y: ROW1_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 315, durationInFrames: 135, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ListOrders", color: "blue", x: QUERY_X + 190, y: ROW1_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 330, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "SearchOrders", color: "blue", x: QUERY_X + 340, y: ROW1_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 345, durationInFrames: 105, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "QueryHandler", color: "orange", x: QUERY_X + 100, y: ROW2_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 360, durationInFrames: 90, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ReadModel", color: "yellow", x: QUERY_X + 310, y: ROW2_Y, delay: 0, width: 150, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 375, durationInFrames: 75, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ReadDB", color: "green", x: QUERY_X + 180, y: ROW3_Y, delay: 0, width: 110, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 390, durationInFrames: 60, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Optimized Views", color: "green", x: QUERY_X + 310, y: ROW3_Y, delay: 0, width: 220, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 165, durationInFrames: 285, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: COMMAND_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: EVENT_X, toY: CONTEXT_Y + 200, delay: 0, color: "#f97316", label: "publishes" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 285, durationInFrames: 165, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: EVENT_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: QUERY_X, toY: CONTEXT_Y + 200, delay: 0, color: "#a855f7", label: "projects" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 405, durationInFrames: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: QUERY_X + 250, fromY: CONTEXT_Y + CONTEXT_HEIGHT + 20, toX: COMMAND_X + 250, toY: CONTEXT_Y + CONTEXT_HEIGHT + 20, delay: 0, color: "#22c55e", label: "reads from optimized views", dashed: true }) })
  ] });
};

;// ./src/compositions/CommandQueryFlow.tsx
...
const CommandQueryFlow = () => {
  ...
  const querySwatchStyle = { ...legendSwatchBase, backgroundColor: "#bbf7d0", border: "2px solid #22c55e" };
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 540, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: titleStyle, children: "Command & Query Flow in CQRS" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 540, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendContainerStyle, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: commandSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Command" })
      ] }),
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 540, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Command Flow (Write Path)", color: "orange", x: COMMAND_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 30, durationInFrames: 510, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: COMMAND_X + 30, top: ROW1_Y, fontSize: 40, width: 40, textAlign: "center" }, children: "\u{1F464}" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: COMMAND_X + 30, top: ROW1_Y + 48, width: 40, textAlign: "center", fontFamily: fontFamily, fontSize: 21, color: "#9a3412" }, children: "User" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 60, durationInFrames: 480, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "PlaceOrderCmd", color: "blue", x: COMMAND_X + 100, y: ROW1_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 90, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "CommandHandler", color: "orange", x: COMMAND_X + 300, y: ROW1_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 120, durationInFrames: 420, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order Aggregate", color: "yellow", x: COMMAND_X + 100, y: ROW2_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 150, durationInFrames: 390, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Validate & Apply", color: "orange", x: COMMAND_X + 320, y: ROW2_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, durationInFrames: 360, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderPlacedEvent", color: "orange", x: COMMAND_X + 100, y: ROW3_Y, delay: 0, width: 220, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 210, durationInFrames: 330, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Event Store", color: "pink", x: COMMAND_X + 340, y: ROW3_Y, delay: 0, width: 160, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 240, durationInFrames: 300, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Event Synchronization", color: "purple", x: SYNC_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 270, durationInFrames: 270, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Event Bus", color: "pink", x: SYNC_X + 200, y: ROW1_Y, delay: 0, width: 130, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 300, durationInFrames: 240, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Subscribe", color: "blue", x: SYNC_X + 60, y: ROW2_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 330, durationInFrames: 210, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Event Handler", color: "orange", x: SYNC_X + 200, y: ROW2_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 360, durationInFrames: 180, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Projector", color: "pink", x: SYNC_X + 400, y: ROW2_Y, delay: 0, width: 120, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 390, durationInFrames: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Update Projection", color: "green", x: SYNC_X + 170, y: ROW3_Y, delay: 0, width: 230, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 420, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Query Flow (Read Path)", color: "green", x: QUERY_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 450, durationInFrames: 90, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: QUERY_X + 30, top: ROW1_Y, fontSize: 40, width: 40, textAlign: "center" }, children: "\u{1F464}" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: QUERY_X + 30, top: ROW1_Y + 48, width: 40, textAlign: "center", fontFamily: fontFamily, fontSize: 21, color: "#166534" }, children: "User" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 465, durationInFrames: 75, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "GetOrderQuery", color: "blue", x: QUERY_X + 100, y: ROW1_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 480, durationInFrames: 60, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "QueryHandler", color: "orange", x: QUERY_X + 290, y: ROW1_Y, delay: 0, width: CARD_WIDTH, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 495, durationInFrames: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Read Model", color: "yellow", x: QUERY_X + 120, y: ROW2_Y, delay: 0, width: 150, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 510, durationInFrames: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderStatusView", color: "green", x: QUERY_X + 290, y: ROW2_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 525, durationInFrames: 15, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderDTO Response", color: "green", x: QUERY_X + 180, y: ROW3_Y, delay: 0, width: 230, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 255, durationInFrames: 285, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: COMMAND_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: SYNC_X, toY: CONTEXT_Y + 200, delay: 0, color: "#f97316", label: "publishes events" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 435, durationInFrames: 105, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: SYNC_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: QUERY_X, toY: CONTEXT_Y + 200, delay: 0, color: "#22c55e", label: "updates read model" }) })
  ] });
};

;// ./src/compositions/AggregateLifecycle.tsx
...
const AggregateLifecycle = () => {
  ...
  const eventSwatchStyle = { ...legendSwatchBase, backgroundColor: "#fed7aa", border: "2px solid #f97316" };
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: containerStyle, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 600, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: titleStyle, children: "Aggregate Lifecycle: Order Example" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 600, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendContainerStyle, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: legendItemStyle, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: commandSwatchStyle }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "Command" })
      ] }),
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 600, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Phase 1: Creation", color: "green", x: PHASE1_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 30, durationInFrames: 570, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "CreateOrderCmd", color: "blue", x: PHASE1_X + 50, y: ROW1_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 60, durationInFrames: 540, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PhaseLabel, { x: PHASE1_X + 250, y: ROW1_Y + 20, text: "customerId, items[]", delay: 0, frame, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 90, durationInFrames: 510, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order (v1)", color: "yellow", x: PHASE1_X + 50, y: ROW2_Y, delay: 0, width: 140, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 120, durationInFrames: 480, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Status: PENDING", color: "orange", x: PHASE1_X + 220, y: ROW2_Y, delay: 0, width: CARD_WIDTH + 30, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 150, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderCreatedEvent", color: "orange", x: PHASE1_X + 100, y: ROW3_Y, delay: 0, width: CARD_WIDTH + 50, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, durationInFrames: 420, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "\u279C Event Store", color: "pink", x: PHASE1_X + 320, y: ROW3_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 200, durationInFrames: 400, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Phase 2: State Change", color: "orange", x: PHASE2_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 230, durationInFrames: 370, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "ConfirmOrderCmd", color: "blue", x: PHASE2_X + 50, y: ROW1_Y, delay: 0, width: 210, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 260, durationInFrames: 340, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PhaseLabel, { x: PHASE2_X + 260, y: ROW1_Y + 20, text: "orderId, paymentRef", delay: 0, frame, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 290, durationInFrames: 310, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order (v2)", color: "yellow", x: PHASE2_X + 50, y: ROW2_Y, delay: 0, width: 140, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 320, durationInFrames: 280, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Status: CONFIRMED", color: "green", x: PHASE2_X + 220, y: ROW2_Y, delay: 0, width: 230, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 350, durationInFrames: 250, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "OrderConfirmedEvent", color: "orange", x: PHASE2_X + 60, y: ROW3_Y, delay: 0, width: 250, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 380, durationInFrames: 220, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "\u279C Event Store", color: "pink", x: PHASE2_X + 330, y: ROW3_Y, delay: 0, width: 180, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 400, durationInFrames: 200, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BoundedContext, { name: "Phase 3: Invariant Protection", color: "blue", x: PHASE3_X, y: CONTEXT_Y, width: CONTEXT_WIDTH, height: CONTEXT_HEIGHT, delay: 0 }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 430, durationInFrames: 170, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "CancelOrderCmd", color: "blue", x: PHASE3_X + 50, y: ROW1_Y, delay: 0, width: 200, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 460, durationInFrames: 140, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PhaseLabel, { x: PHASE3_X + 250, y: ROW1_Y + 20, text: "orderId (already confirmed!)", delay: 0, frame, fps, color: "#dc2626" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 490, durationInFrames: 110, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "Order (v2)", color: "yellow", x: PHASE3_X + 20, y: ROW2_Y, delay: 0, width: 140, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 520, durationInFrames: 80, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "\u274C REJECTED", color: "pink", x: PHASE3_X + 180, y: ROW2_Y, delay: 0, width: 165, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 550, durationInFrames: 50, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PhaseLabel, { x: PHASE3_X + 348, y: ROW2_Y + 20, text: "Invariant violated!", delay: 0, frame, fps, color: "#dc2626" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 570, durationInFrames: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StickyNote, { text: "No Event Emitted", color: "pink", x: PHASE3_X + 180, y: ROW3_Y, delay: 0, width: 210, fontSize: CARD_FONT }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 215, durationInFrames: 385, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: PHASE1_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: PHASE2_X, toY: CONTEXT_Y + 200, delay: 0, color: "#22c55e", label: "version incremented" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 415, durationInFrames: 185, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Arrow, { fromX: PHASE2_X + CONTEXT_WIDTH, fromY: CONTEXT_Y + 200, toX: PHASE3_X, toY: CONTEXT_Y + 200, delay: 0, color: "#f97316", label: "guards state" }) })
  ] });
};
const PhaseLabel = ({ x, y, text, delay, frame, fps, color = "#64748b" }) => {
  const opacity = (0,esm.interpolate)(frame - delay, [0, 15], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const scale = (0,esm.spring)({ frame: frame - delay, fps, config: { damping: 15, stiffness: 100 } });
  if (frame < delay) return null;
  const labelStyle = { position: "absolute", left: x, top: y, transform: `scale(${scale})`, fontFamily: "monospace", fontSize: 18, color, opacity, backgroundColor: "rgba(255,255,255,0.9)", padding: "4px 10px", borderRadius: 4 };
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: labelStyle, children: text });
};

;// ./src/compositions/CourseRoadmap.tsx





const ModuleNode = ({ x, y, number, title, icon, color, delay }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const scale = (0,esm.spring)({
    frame: frame - delay,
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 48, fontFamily: fontFamily, fontWeight: 700, color: "white" }, children: number })
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: 12, fontSize: 36 }, children: icon }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
...
const ConnectionLine = ({ fromX, fromY, toX, toY, delay, curved = false }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const progress = (0,esm.spring)({
    frame: frame - delay,
  ...
  const pathD = curved ? `M ${fromX} ${fromY} Q ${midX} ${midY - curveOffset} ${toX} ${toY}` : `M ${fromX} ${fromY} L ${toX} ${toY}`;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "svg",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("linearGradient", { id: "lineGradient", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: "#3b82f6" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: "#8b5cf6" })
        ] }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "path",
          {
...
const CourseRoadmap = () => {
  ...
  const titleY = (0,esm.interpolate)(frame, [0, 30], [-20, 0], { extrapolateRight: "clamp" });
  const centerX = 960;
  const centerY = 500;
  const modules = [
    { x: 180, y: 280, number: 1, title: "Introduction to DDD", icon: "\u{1F4DA}", color: "#3b82f6" },
    { x: 500, y: 180, number: 2, title: "Bounded Contexts", icon: "\u{1F532}", color: "#06b6d4" },
    { x: 820, y: 280, number: 3, title: "Aggregates & Patterns", icon: "\u{1F9E9}", color: "#10b981" },
    { x: 1140, y: 180, number: 4, title: "Introduction to CQRS", icon: "\u26A1", color: "#f59e0b" },
    { x: 1460, y: 280, number: 5, title: "Event Sourcing", icon: "\u{1F4DC}", color: "#ef4444" },
    { x: 1140, y: 480, number: 6, title: "AI-Assisted Implementation", icon: "\u{1F916}", color: "#8b5cf6" }
  ];
  const connections = [
  ...
  const journeyOpacity = (0,esm.interpolate)(frame, [420, 450], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#f8fafc" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
        ...
        children: "From DDD to CQRS with AI Agents"
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 30, durationInFrames: 870, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
          ...
          fontWeight: 500,
          color: "#64748b",
          opacity: (0,esm.interpolate)(frame, [30, 60], [0, 1], { extrapolateRight: "clamp" })
        },
        children: "Your Learning Journey"
      }
    ) }),
    connections.map((conn, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ConnectionLine,
      {
    ...
    modules.map((mod, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(ModuleNode, { x: mod.x, y: mod.y, number: mod.number, title: mod.title, icon: mod.icon, color: mod.color, delay: moduleDelays[i] }, i)),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 420, durationInFrames: 480, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: "\u2728 6 Modules \u2022 25 Lessons \u2022 Real-World Projects \u2728"
      }
    ) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 480, durationInFrames: 420, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
          ...
          justifyContent: "center",
          gap: 16,
          opacity: (0,esm.interpolate)(frame, [480, 510], [0, 1], { extrapolateRight: "clamp" })
        },
        children: modules.map((mod, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              width: 12,
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "CourseRoadmap", component: CourseRoadmap, durationInFrames: 900, fps: 30, width: 1920, height: 1080 }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "EventStormDemo", component: EventStormDemo, durationInFrames: 450, fps: 30, width: 1920, height: 1080 }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "ContextMapDemo", component: ContextMapDemo, durationInFrames: 360, fps: 30, width: 1920, height: 1080 }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "CQRSArchitecture", component: CQRSArchitecture, durationInFrames: 450, fps: 30, width: 1920, height: 1080 }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "CommandQueryFlow", component: CommandQueryFlow, durationInFrames: 540, fps: 30, width: 1920, height: 1080 }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Composition, { id: "AggregateLifecycle", component: AggregateLifecycle, durationInFrames: 600, fps: 30, width: 1920, height: 1080 })
  ] });
};
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(141), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 8141)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "devmultiplier-animations:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdevmultiplier_animations"] = self["webpackChunkdevmultiplier_animations"] || [];
