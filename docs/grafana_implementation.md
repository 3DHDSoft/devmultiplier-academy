...
flowchart TD
    subgraph App["🚀 Next.js App :3000"]
        OTEL["OpenTelemetry SDK<br/>exports metrics every 60s"]
    end

    subgraph Production["☁️ Production"]
        GC["Grafana Cloud"]
        GCD["Grafana Cloud<br/>Dashboards"]
    end

    subgraph Development["🏠 Development"]
        PROM["Prometheus<br/>(Local)"]
        GRAF["Grafana (Local)<br/>Dashboards<br/>(Auto-provisioned)"]
    end
    ...
    style App fill:#2563eb,stroke:#1e40af,color:#ffffff,stroke-width:3px
    style Production fill:#ea580c,stroke:#c2410c,color:#ffffff,stroke-width:3px
    style Development fill:#16a34a,stroke:#15803d,color:#ffffff,stroke-width:3px
    style Debug fill:#9333ea,stroke:#7e22ce,color:#ffffff,stroke-width:3px
    style OTEL fill:#3b82f6,stroke:#1d4ed8,color:#ffffff,stroke-width:2px
    style GC fill:#f97316,stroke:#ea580c,color:#ffffff,stroke-width:2px
    style GCD fill:#fb923c,stroke:#f97316,color:#ffffff,stroke-width:2px
    style PROM fill:#22c55e,stroke:#16a34a,color:#ffffff,stroke-width:2px
    style GRAF fill:#4ade80,stroke:#22c55e,color:#0f172a,stroke-width:2px
    style LOG fill:#a855f7,stroke:#9333ea,color:#ffffff,stroke-width:2px
```
...
**Implementation Date:** 2026-01-06 **Author:** Claude Sonnet 4.5 **Project:** DevMultiplier Academy
